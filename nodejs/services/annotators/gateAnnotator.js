...
if (process.argv.length < 3) {
  console.log('usage:', process.argv[1], 'Sensebase-path');
  process.exit(1);
}
var sbPath = require('path').resolve(process.argv[2]) + '/';
var querystring = require('querystring'), http = require('http'), cheerio = require('cheerio');

var annoLib = require(sbPath + 'services/annotators/annotateLib.js').init(name), annotations = require(sbPath + 'lib/annotations'), utils = require('../../lib/utils.js');
